...
const oracleResponses = [
  'The stars whisper of a path yet untaken… The realm reveals itself only to those who seek with a pure heart.',
  'Ah, the shadow clears from Eldoria. The Great Tree stirs, and the ancient magic awakens once more.',
  'Beware, traveler. Drakmoor\'s fires burn for the unwary. The dragon bones beneath Mount Pyre still pulse with malice.',
  'In Shadowmere, the dead speak truth where the living lie. Listen closely to the whispers on the twilight wind.',
  'Frosthaven\'s aurora holds the memories of the World-Serpent. Gaze upon it, and you may see the beginning of all things.',
  'The Sunken Isles guard secrets that even I cannot fathom. The Mer-King dreams of the surface world, and his dreams shape the tides.',
  'You have done well to unveil the map. Knowledge is the truest form of power in these lands.',
  'The cartographer who first drew this map wept as he worked — for he knew he would never see these lands with his own eyes.',
  'Time flows differently in the Forgotten Realms. A day in Eldoria may be a year in Drakmoor, and a heartbeat in Shadowmere.',
  'Trust not the roads marked on the map — they shift with the seasons, guided by magic older than memory.',
];

const greeting: Message = {
  id: 0,
  text: 'Greetings, seeker of wisdom. I am the Oracle of the Forgotten Realms. The pool before you reflects all that was, is, and may yet be. Speak your question, and I shall answer…',
  sender: 'oracle',
};
...
const initialSessions: Session[] = [
  {
    id: 'past-1',
    title: 'The Prophecy of Ash',
    timestamp: 'Yesterday',
    messages: [
      greeting,
      { id: 11, text: 'Will Drakmoor rise again?', sender: 'user' },
      { id: 12, text: 'The embers never truly die, traveler. Drakmoor smolders, waiting for a spark of ambition.', sender: 'oracle' },
    ],
  },
  {
    id: 'past-2',
    title: 'Whispers of Shadowmere',
    timestamp: '3 days ago',
    messages: [
      greeting,
      { id: 21, text: 'Who rules Shadowmere now?', sender: 'user' },
      { id: 22, text: 'No king sits upon a throne there. Only the whispers of the departed hold dominion in the eternal dusk.', sender: 'oracle' },
    ],
  },
];
...
const OracleSection: React.FC = () => {
  ...
  const handleSend = () => {
    ...
    setTimeout(() => {
      const response = oracleResponses[responseIndexRef.current % oracleResponses.length];
        ...
        >
          ...
          <div className="flex-1 flex flex-col min-w-0">
            ...
            <div
              ...
              data-lenis-prevent
              style={{ background: 'rgba(18, 14, 10, 0.25)' }}
            >
              {messages.map((msg) => (
